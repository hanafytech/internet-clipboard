...
Securely share text, snippets, or secrets. Data is stored entirely in memory and is **instantly destroyed** the moment it is read by the recipient.
...
3. Type or paste your message and click **Save**.
4. Send the exact URL to your recipient. 
5. Once they open the link, the message is displayed and permanently deleted from the server. Refreshing the page will show an error/empty box.
